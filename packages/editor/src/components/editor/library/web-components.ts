...
export const webLibrary: LibraryComponent[] = [
  // ================= 1. Web 结构与基础图元 (Web Primitives - Atoms) =================
  {
    type: "rectangle",
    label: "卡片底板",
    category: "Web结构",
    ...
    defaultWidth: 360,
    defaultHeight: 240,
    defaultProps: { fill: "var(--surface)", stroke: "var(--border-visible)", borderWidth: 1, radius: 8, fillEnabled: true, strokeEnabled: true },
  },
  {
    type: "text",
    label: "排版文本",
    ...
    defaultWidth: 200,
    defaultHeight: 32,
    defaultProps: { text: "请输入Web页面文本内容", textColor: "var(--foreground)", fontSize: 14, fontWeight: 400, align: "left" },
  },
  {
    type: "line",
    label: "水平分割线",
    ...
    defaultWidth: 320,
    defaultHeight: 16,
    defaultProps: { stroke: "var(--border-visible)", strokeStyle: "solid", borderWidth: 1 },
  },
  {
    type: "image",
    label: "图片占位",
    ...
    defaultWidth: 280,
    defaultHeight: 180,
    defaultProps: { radius: 8, label: "Web图片展示区域", fit: "cover", src: "" },
  },
  {
    type: "browser-frame",
    label: "浏览器视口",
  ...
  },
  {
    ...
    defaultWidth: 120,
    defaultHeight: 48,
    defaultProps: { label: "点击跳转热区", fill: "var(--accent-subtle)", stroke: "var(--accent)" },
  },

  // ================= 2. Web 表单控件 (Web Form Controls - Atoms) =================
  {
    type: "web-button",
    label: "主要操作按钮",
    category: "Web表单",
  ...
  // ================= 3. Web 复合组件 (Web Molecules - Pickers, Nav & Tags) =================
  {
    type: "web-dropdown",
    label: "下拉操作菜单",
    category: "Web复合",
  ...
  // ================= 4. Web 展示与反馈 (Web Organisms - Display & Overlays) =================
  {
    type: "web-top-nav",
    label: "顶部导航栏",
    category: "Web展示与反馈",
