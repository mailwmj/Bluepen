...
export const webLibrary: LibraryComponent[] = [
  // =========================================================================
  // 1. Web 导航组件 (Web Navigation - 页面与骨架导航)
  // =========================================================================
  {
    type: "web-top-nav",
    label: "顶部导航栏",
  ...
  },
  {
    ...
    defaultProps: {
      title: "微服务集群实例详情",
      breadcrumb: "工作台 / 研发项目 / 架构服务",
      description: "查看与管控当前集群节点状态、网络拓扑及健康度指标",
      backButton: true,
      actionText: "新建节点",
      tagText: "PROD-READY",
    },
  ...
  // =========================================================================
  // 2. Web 表单控件 (Web Form Controls - 表单与数据录入)
  // =========================================================================
  {
    type: "web-button",
    label: "主要操作按钮",
  ...
  // =========================================================================
  // 3. Web 数据展示 (Web Data Display - 数据与信息呈现)
  // =========================================================================
  {
    type: "web-table",
    label: "高级数据表格",
  ...
  // =========================================================================
  // 4. Web 反馈与浮层 (Web Feedback & Overlays - 交互反馈与浮层)
  // =========================================================================
  {
    type: "web-modal",
    label: "模态对话框",
