...
export const baseLibrary: LibraryComponent[] = [
  // ================= 1. 基础图元 (Primitives - Atoms) =================
  {
    type: "text",
    label: "文字",
    category: "基础图元",
  ...
  // ================= 2. 基础控件 (Controls - Atoms/Molecules) =================
  {
    type: "button",
    label: "描边按钮",
    category: "基础控件",
  ...
  },
  {
    ...
    defaultWidth: 320,
    defaultHeight: 220,
    defaultProps: { fill: "var(--surface)", stroke: "var(--border-visible)", borderWidth: 1 },
  },
  {
    type: "modal-dialog",
    label: "弹窗浮层",
