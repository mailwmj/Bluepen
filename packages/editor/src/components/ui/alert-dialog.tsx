    ...
    <AlertDialogPortal {...portalProps}>
      ...
      >
        <AlertDialogPrimitive.Popup
          className={cn(
            "relative row-start-2 flex max-h-full min-h-0 w-full min-w-0 max-w-lg flex-col rounded-2xl border border-border-visible bg-surface text-foreground opacity-[calc(1-var(--nested-dialogs))] outline-none transition-opacity duration-200 ease-technical data-ending-style:opacity-0 data-starting-style:opacity-0",
            bottomStickOnMobile &&
...
export function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={cn(
        "font-sans font-medium text-lg leading-snug",
        className,
      )}
