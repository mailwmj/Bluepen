---
name: nothing-design
description: Mandatory project-level UI/UX design system for Bluepen (outlin). Use whenever designing, creating, modifying, styling, or reviewing UI components, inspector panels, canvas controls, dialogs, or frontend views. Enforces Nothing-inspired monochrome aesthetic, Swiss typography, and industrial precision standards.
version: 3.0.0
